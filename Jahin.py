...
jalan("\033[1;97m•◈•───────•◈ I LIKE TO BE ANONYMOUS •◈•───────•◈•")  
...
jalan("   \033[1;91m Please Use Mobile Data ")	

jalan("   \033[1;93m Welcome to JAHIN Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mJahinBCF\033[1;96m•◈•──────────•◈•")

CorrectUsername = "JAHIN"
CorrectPassword = "BCF"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/JahinCivilian/')
    else:
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update JAHIN"																														
...
def pilih_super():
	...
	jalan('                    \033[1;97mJahin start Hacking Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
